...
const VALUES_ANGLE = {
  ...
  selbstbestimmung_handeln:18, stimulation:54, genussstreben:90, erfolgsstreben:126,
  macht_dominanz:153, macht_ressourcen:171, ansehen:189, sicherheit_persoenlich:216,
  sicherheit_gesellschaftlich:234, tradition:261, angepasstheit_hinsichtlich_regeln:279,
  angepasstheit_gegenüber_anderen:297, bescheidenheit:315, universalismus_toleranz:333,
...
const LABEL_FULL = {
  ...
  stimulation:'Anregung', genussstreben:'Genussstreben', erfolgsstreben:'Erfolgsstreben',
  ...
  tradition:'Tradition', angepasstheit_hinsichtlich_regeln:'Angepasstheit hinsichtlich Regeln',
  angepasstheit_gegenüber_anderen:'Angepasstheit gegenüber anderen', bescheidenheit:'Bescheidenheit',
...
const HOG = {
  offenheit_fuer_wandel: ['selbstbestimmung_denken','selbstbestimmung_handeln','stimulation','genussstreben'],
  selbsterhoehung: ['erfolgsstreben','macht_dominanz','macht_ressourcen','ansehen'],
  bewahrung: ['sicherheit_persoenlich','sicherheit_gesellschaftlich','tradition','angepasstheit_hinsichtlich_regeln','angepasstheit_gegenüber_anderen','bescheidenheit'],
